...
\begin{align}
		...
		\label{eq:tri-pts/6} \vec{F}-\vec{G} = \myvec{\frac{1}{2} \\ \frac{5}{2}} \\
		\label{eq:tri-pts/7} \vec{G}-\vec{C} = \myvec{1 \\ 5} \\
		\label{eq:tri-pts/8} \vec{G}-\vec{A} = \myvec{-3 \\ 1} \\
		\label{eq:tri-pts/9} \vec{D}-\vec{G} = \myvec{\frac{-3}{2} \\ \frac{1}{2}}
\end{align}
Using the equation,
 		\eqref{eq:tri-pts/4},
		\eqref{eq:tri-pts/5},
